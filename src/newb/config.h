...
#define NL_TINT_LOW  vec3(0.38,0.55,1.25) // color tint for dark tone
#define NL_TINT_HIGH vec3(1.15,0.78,0.45) // color tint for light tone

/* Terrain lighting */
#define NL_SUN_INTENSITY 1.0    // 0.5 weak ~ 5.0 bright
...
#define NL_MORNING_SUN_COL vec3(1.00,0.52,0.22)
#define NL_NOON_SUN_COL    vec3(1.00,0.82,0.67)
#define NL_NIGHT_SUN_COL   vec3(0.38,0.55,0.95)

/* Ambient light on terrain (light that is added everywhere) */
#define NL_NETHER_AMBIENT vec3(1.4,1.0,0.9)
#define NL_END_AMBIENT    vec3(0.2,0.1,0.5)

/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(1.20,0.75,0.35)
#define NL_UNDERWATER_TORCH_COL vec3(0.85,0.48,0.26)
#define NL_NETHER_TORCH_COL     vec3(1.10,0.36,0.16)
#define NL_END_TORCH_COL        vec3(0.90,0.40,0.21)
...
#define NL_DAY_ZENITH_COL    vec3(0.18,0.38,0.65)
#define NL_DAY_HORIZON_COL   vec3(0.30, 0.50, 0.72)
#define NL_NIGHT_ZENITH_COL  vec3(0.002,0.004,0.12)
#define NL_NIGHT_HORIZON_COL vec3(0.05,0.08,0.18)
#define NL_RAIN_ZENITH_COL   vec3(0.42,0.50,0.60)
#define NL_RAIN_HORIZON_COL  vec3(0.32,0.38,0.45)
#define NL_END_ZENITH_COL    vec3(0.00,0.00,0.00)
#define NL_END_HORIZON_COL   vec3(0.20,0.05,0.60)
#define NL_DAWN_ZENITH_COL   vec3(0.20,0.05,0.60)
#define NL_DAWN_HORIZON_COL  vec3(0.82,0.42,0.28)
#define NL_DAWN_EDGE_COL     vec3(1.0,0.45,0.22)
...
#define NL_WATER_TINT vec3(0.40,0.70,0.92)

/* Underwater */
#define NL_UNDERWATER_BRIGHTNESS 0.22          // 0.0 dark ~ 3.0 bright
#define NL_CAUSTIC_INTENSITY 0.8               // 0.5 weak ~ 5.0 bright
...
#define NL_UNDERWATER_TINT vec3(0.35,0.55,0.75) // fog tint color when underwater

/* Cloud type */
#define NL_CLOUD_TYPE 2 // 0:vanilla, 1:soft, 2:rounded, 3:realistic

/* Vanilla cloud settings - make sure to remove clouds.png when using this */
#define NL_CLOUD0_THICKNESS 0.5      // 0.5 slim ~ 8.0 fat
#define NL_CLOUD0_RAIN_THICKNESS 1.0 // 0.5 slim ~ 8.0 fat
#define NL_CLOUD0_OPACITY 0.70       // 0.0 invisible ~ 1.0 opaque
...
#define NL_CLOUD1_DENSITY 0.65             // 0.1 less clouds ~ 0.8 more clouds
...
#define NL_CLOUD2_SCALE vec2(0.010, 0.010)   // 0.003 large ~ 0.3 tiny
#define NL_CLOUD2_SHAPE vec2(0.4, 0.4)     // 0.0 round ~ 1.0 box vec2(horizontal shape, vertical shape)
...
#define NL_CLOUD2_LAYER2_OFFSET 100.0           // 30.0 near ~ 300.0 very high
#define NL_CLOUD2_LAYER2_THICKNESS 1.0          // 0.7 slim ~ 5.0 fat
#define NL_CLOUD2_LAYER2_RAIN_THICKNESS 1.0     // 0.7 slim ~ 5.0 fat
#define NL_CLOUD2_LAYER2_STEPS 4                // 3 low quality ~ 16 high quality
#define NL_CLOUD2_LAYER2_SCALE vec2(0.023, 0.023) // 0.003 large ~ 0.3 tiny
#define NL_CLOUD2_LAYER2_SHAPE vec2(0.4, 0.4)   // 0.0 round ~ 1.0 box vec2(horizontal shape, vertical shape)
#define NL_CLOUD2_LAYER2_DENSITY 50.0           // 1.0 blurry ~ 100.0 sharp
#define NL_CLOUD2_LAYER2_VELOCITY 4.0          // 0.0 static ~ 4.0 very fast

/* Realistic cloud settings */
#define NL_CLOUD3_SCALE vec2(0.025, 0.025) // 0.003 large ~ 1.0 tiny
#define NL_CLOUD3_SPEED 0.0025            // 0.0 static ~ 4.0 fast moving
#define NL_CLOUD3_SHADOW 0.95             // 0.1 subtle ~ 1.0 dark
...
#define NL_AURORA_COL1 vec3(1.0,1.0,1.0)
#define NL_AURORA_COL2 vec3(1.0,1.0,1.0) 

/* Shooting star */
#define NL_SHOOTING_STAR 1.0        // [toggle] 0.2 dim ~ 1.0 bright
#define NL_SHOOTING_STAR_PERIOD 12.0 // 0.4 fast ~ 12.0 slow (12 secs)
...
#define NL_SUNMOON_RAIN_VISIBILITY 0.6 // 0.0 invisible during rain ~ 1.0 always visible
...
#define NL_ENTITY_BRIGHTNESS     1.00 // 0.1 dark ~ 1.6 bright
#define NL_ENTITY_EDGE_HIGHLIGHT 0.80 // [toggle] 0.0 no highlight ~ 1.6 bright highlight

/* Weather particles */
#define NL_WEATHER_SPECK 0.3         // [toggle] 0.0 vanilla texture ~ 1.0 soft speck
#define NL_WEATHER_RAIN_SLANT 1.0    // 1.0 minimal ~ 8.0 violent
#define NL_WEATHER_PARTICLE_SIZE 0.1 // 0.5 tiny ~ 4.0 large
...
/*#ifdef ULTRA_LOW_MODE
  // pongo a low mode como base 
  #define LOW_MODE
  #undef NL_CLOUD_TYPE 
  ...
  #define NL_WATER_TEX_OPACITY 1.0
  #define NL_WATER_BUMP 0.0
#endif*/
#ifdef LOW_MODE
  #undef NL_CLOUD_TYPE 
  #define NL_CLOUD_TYPE 0
  #undef NL_GLOW_SHIMMER_SPEED
  ...
  #define NL_CLOUD2_SCALE vec2(0.023,0.023) 
  #undef NL_CLOUD2_SHAPE
  #define NL_CLOUD2_SHAPE vec2(0.8,0.8)    
  #undef NL_CLOUD2_DENSITY
  #define NL_CLOUD2_DENSITY 100.0       
  #undef NL_CLOUD2_VELOCITY
  #define NL_CLOUD2_VELOCITY 4.0         
#endif

/*#ifdef HIGH_MODE_SOFT_CLOUDS desactivado por ahora 
  #undef NL_CLOUD_TYPE
  #define NL_CLOUD_TYPE 1
#endif*/

#ifdef HIGH_MODE_REDOUNDED_CLOUDS
  #undef NL_CLOUD_TYPE
  #define NL_CLOUD_TYPE 2
#endif

#ifdef HIGH_MODE_REALISTIC_CLOUDS
  #undef NL_CLOUD_TYPE
